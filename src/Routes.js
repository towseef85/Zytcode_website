  ...
  useEffect(() => {
    ...
    return (
        ...
        <Switch>
          ...
          <Route exact path="/projectSingle" component={ComponentWithLayout2(ProjectSingle)} />
          <Route exact path="/serviceSingle" component={ComponentWithLayout2(serviceSingle)} />
        </Switch>
        </BrowserRouter>
    )
}
